...
public class ETCDClient {
    ...
    public void put(String key, String value) throws IOException {
        System.out.println("Registering the node as key : " + key);
        System.out.println("Registering the node with values : " + value);
    ...
    public String get(String key) throws IOException {
        System.out.println("Getting service details for Key : " + key);
